import Acceleration_Card from "../components/Acceleration_Card/Acceleration_Card";
import "./style.css"
    ...
    const posts =[
        {
            ...
            <path d="M30 18.7996V29.732C30 29.8991 30.0836 30.0553 30.2226 30.148L38.4 35.5996" stroke="white" stroke-width="4" stroke-linecap="round"/>
          </svg>,
            title: "Courses",
        ...
        },
        {
            ...
            <path d="M37 9.25V15.4167M16.3852 22.5519L12.0247 18.1914M57.6145 22.5519L61.975 18.1914M18.5 46.25C18.5 36.0327 26.7827 27.75 37 27.75C47.2173 27.75 55.5 36.0327 55.5 46.25M67.8333 46.25H6.16666M58.5833 58.5833H15.4167" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
            ,
            title: "Courses",
            desc: "Our educational platform is accessible 24/7, enabling continuous learning and assimilation of course materials at your convenience.",
