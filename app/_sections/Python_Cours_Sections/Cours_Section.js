...
export default function Cours_Section() {
    ...
    const items = [
        ...
        },
        {
            ...
            content:[ "Introduction to Python ", "Python Installation and Setup Basic ", "Structure of a Python Program ", "Building Your First Python Program"],
        },
        {
            title: " Language Basics",
            content:[ "Variables and Data Types ", "Working with Operators", "Control Flow with Conditionals and Loops ", "Functions and Modules: Building Reusable Code"],
        },
        {
            title: "  Object-Oriented Programming",
            content:[ "Core Concepts of Object-Oriented Programming (OOP) ", "Defining Classes and Objects ", "Utilizing Objects in Your Code"],
        },
        {
            title: "  Fundamental Data Structures",
            content:[ "Lists: Managing Ordered Collections of Data  ", "Sets: Working with Unique Elements ", "Tuples: Immutable Ordered Sequences ", "Dictionaries: Key-Value Pair Structures"],
        },
        {
            title: "   Python Data Science libraries",
            content:[ "NumPy: Powerful Numerical Computing Library ", "Pandas: Data Analysis and Manipulation with DataFrames " , "Matplotlib: Creating Data Visualizations"],
        },
        {
            title: "   Final Project",
