...
export default function Innovation() {
    const posts = [
        {
            title: "Our Mission",
            description: "At Cambridge BraineX, we fuse and apply emerging technologies that empowers industries like AI and embedded systems, to turn complex challenges into intelligent, actionable solutions. Our mission is to explore, innovate, enhance lives, and unlock new possibilities across sectors.",
        ...
        {
            title: "Our Vision",
            description: "We envision a world where intelligent systems seamlessly collaborate with human expertise, driving smarter industries, resilient economies, and sustainable progress. Cambridge BraineX aspires to be at the forefront of this transformation, leading breakthroughs that redefine how technology serves people, businesses, and society.",
        ...
        {
            title: "Our Goal",
            description: "Our goal is to deliver real-world impact through innovation. We partner with organizations to craft tailored, integrated solutions that not only solve today’s challenges but anticipate tomorrow’s needs. By blending scientific rigor with creative engineering, we strive to make advanced technologies accessible, practical, and transformative.",
