            ...
            <div className="grid md:grid-cols-2 gap-[20px]  md:gap-[40px] absolute left-0 bottom-0 z-10  overflow-hidden md:p-[40px]">
                <div className="bg-white p-8 item-ai rounded-[8px]">
                    ...
                    <div>
                        ...
                        AI in Supply Chain: "Efficient Supply Networks"
                        </p>
                        <p>
                        Optimizing supply chain operations with predictive analytics, intelligent automation, and real-time tracking to boost efficiency and resilience.
                        </p>
                    </div>
                </div>
                <div className="bg-white p-8 item-ai rounded-[8px]">
