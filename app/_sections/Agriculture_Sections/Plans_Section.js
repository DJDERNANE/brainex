    ...
    return (
        <div className=" pb-[100px] mx-auto container" id="get_in_touch">
            <div className="grid md:grid-cols-2 text-white py-[70px] items-center">
                ...
                <p>
                Seamless delivery, measurable outcomes, and helping you lead in 
                an increasingly competitive global agricultural market
                </p>
            </div>
            ...
            <div className={`${show ? "md:p-[100px]" : "md:p-[200px]"}  flex md:justify-start justify-center md:gap-6 plans  `}>
                <div className={`card-cours-price oil ${show ? "show" : ""}`}>
                    ...
                    <p className={`note long ${show ? "hidden" : ""}`}>
                    Unlock the potential of AI to transform your agricultural operations—enhance productivity, reduce costs, and promote sustainability.
                    </p>
