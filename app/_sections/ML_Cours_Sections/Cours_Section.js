    ...
    const items = [
        {
            ...
            content: ["This course introduces you to the fundamentals of machine learning, empowering you to understand its applications and impact. You'll explore the techniques behind data-driven decision-making."],
        },
        {
            title: " Introduction to AI",
            content: ["Definition of Artificial Intelligence (AI)", "Subsets of Artificial Intelligence"],
        },
        {
            title: "Machine learning definition",
            content: ["Supervised Machine Learning", "Unsupervised Machine Learning", "The Role of Data in AI", "Machine Learning Project Lifecycle"],
        },
        {
            title: " Data preparation for  AI",
            content: ["Understanding what’s Features selection","Working on Dataset by applying Data pre-processing and Data splitting."],
        },
        {
            title: "Supervised machine learning",
            content: ["Learn supervised machine learning algorithms (such as linear regression, KNN, SVM, etc.) in real-world scenarios."],
        },
        {
            title: " Unsupervised machine learning",
            content: ["Learn about unsupervised machine learning algorithms, including hierarchical classification, partitioning (such as k-means)."]
        },
        {
            title: "  Fasts API",
            content: ["Learn how to create an API using the FastAPI library."]
        },
        {
            title: "Postman",
            content: ["Learn how to use Postman to test your APIs."]
        },
        {
            title: "Final Project",
            content: ["Create a project within 15 days to apply all that you have learned in the course"]
        }
    ]
    const toggleShowAll = () => {
