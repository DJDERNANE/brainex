"use client"
import "./style.css"
import Dashboard_Item from "../../_components/Dashboard_Item/Dashboard_Item";
...
export default function Cours_Section() {
    ...
    const dashboardItems = [
        ...
        {
            img: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.5 4.375V6.25H2.5V4.375C2.5 4.20924 2.56585 4.05027 2.68306 3.93306C2.80027 3.81585 2.95924 3.75 3.125 3.75H16.875C17.0408 3.75 17.1997 3.81585 17.3169 3.93306C17.4342 4.05027 17.5 4.20924 17.5 4.375Z" fill="#8B959E"/>
    ...
    const items = [
        {
            ...
            content: ["This course dives into the concepts and techniques behind neural networks, showcasing their role in powering advancements like computer vision and natural language processing."],
        },
        {
            title: " Introduction to Deep Learning",
            content: ["Understanding Deep Learning and Its Importance", "From Perceptrons to Neural Networks ","Exploring Hyperparameters and Gradient Descent ", "Optimizers and Loss Functions in Deep Learning ", "Hands-On: Building Your First Neural Network"],
        },
        {
            title: "Deep Learning for Computer Vision",
            content: ["Introduction to Computer Vision with Deep Learning ", "Understanding Convolutional Neural Networks (CNNs)", " Data Preprocessing and Augmentation Techniques ", " Building and Training CNNs for Image Classification", "Transfer Learning and Fine-Tuning Pre-Trained Models"],
        },
        {
            title: "Sequential Data and Recurrent Neural Networks",
            content: ["Working with Sequential Data in Deep Learning ", "Introduction to Recurrent Neural Networks (RNNs) ", "Exploring Long Short-Term Memory (LSTM) Networks ", "Hands-On: LSTMs for Text Generation and Time Series Forecasting ","Applications in Speech Recognition and Machine Translation"],
        },
        {
            title: "Natural Language Processing with Deep Learning",
            content: [" Introduction to NLP and Its Importance ", "Text Preprocessing Techniques for Deep Learning ", ""],
        },
        {
            title: " Unsupervised machine learning",
            content: ["Learn about unsupervised machine learning algorithms, including hierarchical classification, partitioning (such as k-means).", "Using Word Embeddings (Word2Vec, GloVe) in NLP Models ", "Building RNNs, LSTMs, and Transformers for NLP ", " Fine-Tuning BERT for NLP Tasks"]
        },
        {
            title: " Deep Generative Models",
            content: [" Introduction to Generative Models and Their Applications", "Exploring Autoencoders and Variational Autoencoders (VAEs) ", "Understanding Generative Adversarial Networks (GANs) ", "Hands-On: Building and Training a GAN for Image Generation"]
        },
        {
            title: "Final Project",
            content: ["Applying Generative Models in Real-World Scenarios"]
        }
    ]
    const toggleShowAll = () => {
    ...
    return (
        <div className="cours-section container flex py-[00px] w-full gap-[50px] py-[150px]">
            <div className="cours-dashboard flex-2">
                <h1 className="cours-h1 pb-2">Fullstack JavaScript</h1>
                <div className="dashboard-container">
                    {dashboardItems.map((item, index) => (
                        <Dashboard_Item key={index} img={item.img} text={item.text} />
                    ))}
                </div>
            </div>
            <div className="flex-1">
            <button onClick={toggleShowAll} className="text-white">{show ? "Hide All" : "Show All"}</button>
                <div>
                    <AccordionComponent items={items} course={true} openAll={show}/>
                </div>
            </div>
        </div>
    );
